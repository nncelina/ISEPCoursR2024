...
depenses_de_consommation <- basefusionnee$prix_unitaire*basefusionnee$Qtty_cons
View(basefusionnee)
...
Q1= quantile(basefusionnee$Qtty_cons, 0.25)
Q3= quantile(basefusionnee$Qtty_cons, 0.75)
IQR<- Q3-Q1
ifelse(basefusionnee$Qtty_cons < 3-1.5*IQR & basefusionnee$Qtty_cons > 14+1.5*IQR, basefusionnee <- median(basefusionnee$Qtty_cons), basefusionnee$Qtty_cons <-basefusionnee$Qtty_cons)
